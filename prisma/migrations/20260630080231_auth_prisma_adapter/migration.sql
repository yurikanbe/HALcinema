...
-- DropForeignKey
ALTER TABLE "screening_seat_locks" DROP CONSTRAINT "screening_seat_locks_user_id_fkey";
...
-- AlterTable
ALTER TABLE "notification_settings" ALTER COLUMN "user_id" SET DATA TYPE TEXT;

-- AlterTable
ALTER TABLE "screening_seat_locks" ALTER COLUMN "user_id" SET DATA TYPE TEXT;

-- AlterTable
ALTER TABLE "user_favorites" ALTER COLUMN "user_id" SET DATA TYPE TEXT;
