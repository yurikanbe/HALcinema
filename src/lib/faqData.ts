...
export const FAQ_SEARCH_ITEMS: FaqSearchItem[] = [
  ...
  },
  {
    ...
    categoryLabel: '座席・シアター',
    question: '席交換リクエストとは？',
    answer: '先約のある席を希望する場合、+100円でその席の予約者に席の交換をリクエストできます。承諾してくださった方には100円のキャッシュバックがあります。承諾側は別の空席を選んで予約を続けるか、その日の予約をキャンセルすることもできます。1件でも拒否されると、同じ予約の他のリクエストはすべて自動キャンセルされます。詳細はログイン後の予約画面よりご確認ください。',
  },
  {
    id: 'payment-1',
    category: 'payment',
